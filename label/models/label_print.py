...
class LabelPrint(models.Model):
    ...
    default_label_brand_id = fields.Many2one('label.brand', 'Label')
    defualt_label_config_id = fields.Many2one('label.config', 'Config')
...
class LabelPrintField(models.Model):
    ...
    python_field = fields.Char('Fields', size=60)
