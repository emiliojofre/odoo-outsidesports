odoo.define('nlh_website_sale_options.website_sale', function(require) {
"use strict";
...
$('.oe_website_sale #add_to_cart, .oe_website_sale #products_grid .a-submit, .oe_website_sale .js_check_product')
    .off('click')
